...
public class NodeView extends JComponent {
    ...
    //int radius;
    public  NodeView(CommModule _comm,int width , int height){
        comm =_comm;
        //this.gui =comm.gui;
    ...
    public void setTopology(){
        ...
        for(int i=0 ;i<comm.num_nodes;i++){
            theta[i] = (2*Math.PI)* i / comm.num_nodes;
    ...
    class newMessageChecker extends Thread{
        ...
        public void run(){
            while(true){
                ...
                if(e.eventType =='b')
                    for(int i =0; i< comm.num_nodes; i+=1){
                        e.msg.destId = i;
    ...
    class GuiNode {
        ...
        public void drawNode(Graphics2D g){
            ...
            int myColor = comm.getNodeColor(myId);
             if( myColor> 0){
                Color oldC = g.getColor();
