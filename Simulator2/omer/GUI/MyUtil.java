...
public class MyUtil {
    ...
    public static String getArrayString(boolean[] arr){
    	String str = new String();
    	str = "[ ";
    	for (int i = 0; i < arr.length; i++){
    		str += arr[i] + " ";
...
//    public static Object invokeMethod(Event event)
//    {
//    	Util.println("invokeMethod: " + event);
//    	return invokeMethod(event.getObject(), event.getClassName(),event.getMethodName(), event.getArgs());
//    }
//    public static Object invokeMethod(Object object, String className, String methodName, Object[] argList)
//    {
//    	Class cls;
//    	Method method;
...
//            method = cls.getMethod(methodName,argTypeList);
//            ret = method.invoke(object,argList);
//          }
//          catch (Throwable e) {
